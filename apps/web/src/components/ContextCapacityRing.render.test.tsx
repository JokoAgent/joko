...
describe("context capacity presentation", () => {
  it("formats visible capacity and uses estimates only without a runtime measurement", () => {
  ...
  it("uses the measured live window even when the model catalog advertises a larger window", () => {
    ...
    expect(unknown).not.toContain("0 / 1M");
