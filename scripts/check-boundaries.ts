...
export const WORKSPACE_DEPENDENCY_ALLOWLIST: Readonly<Record<string, ReadonlySet<string>>> = {
  ...
  "@joko/e2e": new Set(["@joko/adapter-claude-code", "@joko/adapter-pi", "@joko/contracts", "@joko/core", "@joko/orchestrator", "@joko/remote-ssh", "@joko/store", "@joko/testkit", "@joko/tool-terminal"]),
