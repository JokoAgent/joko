...
export const WORKSPACE_DEPENDENCY_ALLOWLIST: Readonly<Record<string, ReadonlySet<string>>> = {
  ...
  "@joko/adapter-transcription-scribe": new Set(["@joko/voice-input"]),
  "@joko/adapter-transcription-sauc": new Set(["@joko/voice-input"]),
  ...
  "@joko/e2e": new Set(["@joko/adapter-claude-code", "@joko/adapter-pi", "@joko/contracts", "@joko/core", "@joko/messaging", "@joko/orchestrator", "@joko/remote-ssh", "@joko/store", "@joko/testkit", "@joko/tool-browser", "@joko/tool-terminal"]),
  "@joko/orchestrator": new Set(["@joko/code-host", "@joko/contracts", "@joko/core", "@joko/git-safety", "@joko/local-model-runtime", "@joko/messaging", "@joko/outbound-network", "@joko/remote-ssh", "@joko/runtime-governance", "@joko/store", "@joko/adapter-claude-code", "@joko/adapter-codex", "@joko/adapter-dictation-refinement", "@joko/adapter-pi", "@joko/adapter-transcription-openai", "@joko/adapter-transcription-realtime", "@joko/adapter-transcription-scribe", "@joko/adapter-transcription-sauc", "@joko/tool-android", "@joko/tool-browser", "@joko/tool-computer", "@joko/tool-document", "@joko/tool-lsp", "@joko/tool-terminal", "@joko/voice-input", "@joko/worktree", "@joko/testkit"]),
